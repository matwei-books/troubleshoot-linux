...
*tools/perf/* `make` aufrufen, um das für diesen Kernel passende Programm zu
erhalten.
...
Allerdings kann es vorkommen, dass der ermittelte Befehlszählerwert auf Grund
von Verzögerungen bis zum Aufruf des Handlers nicht ganz exakt ist.
...
Die Messungen können global oder eingeschränkt auf eine Task oder eine
*cgroup* vorgenommen werden.

### Aufruf des Programmes

Ich kann das Programm `perf` auf eine der folgenden fünf Arten verwenden:
...
Dieser Aufruf benötigt erweiterte Rechte.
...
Performancedaten nicht ausgegeben, sondern in *perf.data* gespeichert.
