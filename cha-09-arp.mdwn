...
ergänzt worden.
Für IPv6 wird dafür das Neighbor Discovery Protocol verwendet, das in RFC 4861
beschrieben ist.
...
Proxy-ARP kann man zum Beispiel einsetzen, wenn zwei Netzsegmente zwar durch
Router getrennt sind, aber als ein ganzes Segment erscheinen sollen.
Im Gegensatz zur Kopplung mit einer Bridge werden in diesem Fall keine
Broadcasts zwischen den Netzen ausgetauscht.
