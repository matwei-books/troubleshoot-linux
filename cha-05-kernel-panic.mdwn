...
Eine Kernel-Panik ist eine Meldung des Kernels nachdem ein Fehler auftrat,
...
die für Laien meist unverständlich sind, jedoch dem Experten manchmal einen
Hinweis auf die Ursache geben können.
Anschließend wird das Betriebssystem angehalten.
...
zu bestimmen, habe ich bei neueren Kerneln die Möglichkeit, im Fall einer
...
starten in dem ein Speicherabzug des alten Kernels gesichert werden kann.

Das Speicherabbild des alten Kernels bleibt während des Reboots erhalten und
ist für den neuen Kernel zugänglich.
Wenn der neue Kernel gestartet ist, kann das Speicherabbild für die spätere
...
Zur Analyse selbst sollte wieder der Standard-Kernel gestartet werden.
